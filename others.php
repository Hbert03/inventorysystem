        ...
        <form action="" method="POST"  enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
              ...
              <select class="form-control others1" name="select1" required></select>
            ...
            <div class="col-md-6">
              <label for="examDropdown"></label>
              <select class="form-control others2 mb-1" name="select2" required></select>
          ...
          <button type="submit" class="btn btn-primary btn-sm btn-block mb-1" name="createsss1">SAVE</button>
        </form> 
      </div>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body w-100">
                <table id="showTable_others" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                    <th>Description </th>
