...
if (isset($_SESSION['personnel']) || isset($_SESSION['admin']) || isset($_SESSION['employee_name']) || isset($_SESSION['user_id'])
 || isset($_SESSION['office_id']) || isset($_SESSION['office_id']) || isset($_SESSION['user_id_sch'])) {
...
<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . AMS_PATH . 'school/sch_dashboard.php';
 ?>
...
<?php
    include $_SERVER['DOCUMENT_ROOT'] . AMS_PATH . 'school/footer.php';
 ?>
