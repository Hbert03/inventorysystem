...
<nav class="mt-2" id="sidebarNav">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    <li class="nav-item ">
      <a href="invent_school.php" class="nav-link">
        <i class="nav-icon fas fa-home"></i>
        <p>Home</p>
      </a>
    </li>
	<li class="nav-item ">
      <a href="land.php" class="nav-link">
    ...
    <li class="nav-item has-treeview ">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="office_building.php" class="nav-link">
             <i class="nav-icon fas fa-building"></i>
		  <p>Office Buildings</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="school_building.php" class="nav-link">
		  <i class="nav-icon fas fa-building"></i>
            <p>School Buildings</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="others_structure.php" class="nav-link">
          <i class="nav-icon fas fa-building"></i>
            <p>Other Structures</p>
          </a>
        </li>
		<li class="nav-item">
          <a href="historical_building.php" class="nav-link">
          <i class="nav-icon fas fa-building"></i>
            <p>Historical Building</p>
          </a>
        </li>
      </ul>
    </li>
