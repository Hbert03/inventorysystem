...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <div class="modal fade" id="editmodalbuild1" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-12 col-md-6">
          <label for="modal-input9" class="form-label">Accountable Officer</label>
          <select type="text" class="form-control edit_personnel" id="modal-input9"></select>
          </div>
          <div class="col-12 col-md-6">
