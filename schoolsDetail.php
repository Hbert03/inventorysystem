							...
							<tbody>
								<?php
									...
									while($personnelRow = mysqli_fetch_array($personnelIns,MYSQLI_ASSOC)){
										$name = getFullname($personnelRow['office_head']);
										//$position = $name = $personnelRow['position'];
										//$personnelType='1';
										//$teacherCount=get_teacherRows($personnelRow['id'],'1');
											echo '<tr>
														<td>'.$personnelRow['district'].'</td>
														<td>'.$personnelRow['office_id'].'</td>
														<td>'.$personnelRow['office_name'].'</td>
														<td>'.$name.'</td>
														<td>'.cntTeaching($personnelRow['officetable_id'],'3').'</td>
														<td>'.cntTeaching($personnelRow['officetable_id'],'1').'</td>
														<td>'.cntTeaching($personnelRow['officetable_id'],'2').'</td><td>'.$personnelRow['type'].'</td>
													</tr>';
