...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini">
                ...
                <form method="POST">
					...
					<div class="row" style="border-radius:10px;">
						...
						<div class="col-lg-3 col-md-6 mb-2">
							...
							<select name="empStat" id="empStat" class="form-control select2" style="width:100%;"required/>
						...
						<div class="col-lg-4 col-md-6 mb-2">
                            ...
                            <select type="text" class="form-control select2" name="deptId" id="deptId" required/>
								<option value="">Select School</option>
								<?php
									$selectSchool = "select * from tbl_office";
									$schoolIns = mysqli_query($fconn2,$selectSchool);
									
									while($schoolRow = mysqli_fetch_array($schoolIns,MYSQLI_ASSOC)){
										echo '<option value="'.$schoolRow['id'].'">'.$schoolRow['office_id'].", ".$schoolRow['office_name'].'</option>';
									}
								?>
							</select>
                        </div>
                    ...
                    <div class="row mb-2" style="border-radius:10px;">
                            <div class="col-sm-3">
                                <label>TIN</label>
                    ...
                    <button type="submit" class="btn btn-success btn-sm btn-block mt-2" name="createEmployee" >CREATE</button>
					</div>
				</form>
		...
		$(document).ready(function(){
			document.getElementById('employeeButton').className = "nav-link active";
		});
		$(function (){
			$(".table").DataTable({
				"responsive": true,
