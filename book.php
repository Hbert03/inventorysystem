        ...
        <form action="" method="POST"  enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
              ...
              <select class="form-control book1" name="select1" required></select>
            ...
            <div class="col-md-6">
              <label for="examDropdown"></label>
              <select class="form-control book2 mb-1" name="select2" required></select>
              <input type="text" class="form-control mt-2 mb-1" name="qty_card" id="qty_card" placeholder="Qty Card">
						...
						<input type="text" class="form-control mb-1" name="remarks" id="remarks" placeholder="Remarks" required>
						<input type="text" class="form-control mb-1" name="account_off" id="account_off" placeholder="Accountable Officer">  
            </div>
          </div>
          <button type="submit" class="btn btn-primary btn-sm btn-block mb-1" name="create_books">SAVE</button>
        </form> 
      </div>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body w-100">
                <table id="showTable_books" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                    <th>Description </th>
